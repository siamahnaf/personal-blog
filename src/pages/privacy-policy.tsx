        ...
        <Layout>
            ...
            <Container className="pt-40 pb-16">
                ...
                <div>
                    ...
                    <h2 className="text-3xl font-bold">Responsibility of Contributors</h2>
                    ...
                    <h2 className="text-3xl font-bold">Gathering of Personal Information</h2>
                    ...
                    <h2 className="text-3xl font-bold">Protection of Personal Information</h2>
                    ...
                    <h2 className="text-3xl font-bold">Privacy Policy Changes</h2>
